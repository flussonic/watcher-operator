...
# flussonic.com/watcher-operator-bundle:$VERSION and flussonic.com/watcher-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= flussonic/watcher-operator
...
IMG ?= flussonic/watcher-controller:$(VERSION)
